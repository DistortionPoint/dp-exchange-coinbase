defmodule DpExchange.Coinbase.ForwardedNilTest do
  ...
  test "Supervisor.limiter_name/1 with a forwarded `limiter: nil` names this venue's limiter" do
    ...
    assert DpExchange.Coinbase.Supervisor.limiter_name(limiter: nil) ==
             DpExchange.Coinbase.Supervisor.limiter_name([])

    refute is_nil(DpExchange.Coinbase.Supervisor.limiter_name(limiter: nil))
  end
end
