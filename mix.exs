defmodule DpExchangeCoinbase.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      # Hex.pm
      name: "DpExchangeCoinbase",
      description:
        "EXPERIMENTAL — Coinbase venue package for the DpExchange family. Market data, " <>
  ...
  # consumer that has not asked for Coinbase must not find a socket open.
  def application do
